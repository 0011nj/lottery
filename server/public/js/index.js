...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //基础模块开发
	...
	var Base = function () {
	   ...
	   */
			...
			value: function addCode() {
				var self = this;
				var $active = (0, _jquery2.default)('.boll-list .btn-boll-active').text().match(/\d{2}/g); //获取选中的号码
	...
	var Calculate = function () {
	   ...
	   */
			value: function computeCount(active, play_name) {
				var count = 0; //默认注数0
				var exist = this.play_list.has(play_name); //判断是否有此玩法
				var arr = new Array(active).fill('0'); //创建active长度默认为0的数组
